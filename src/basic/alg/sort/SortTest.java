...
import basic.alg.sort.BubbleSort;
import basic.alg.sort.LinearInsertSort;
import basic.alg.sort.QuickSort;
import basic.alg.sort.SelectionSort;
...
public class SortTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("排序前的数组：");
        printIntArray(iNums);
        ISortNumber = test = new BubbleSort();
